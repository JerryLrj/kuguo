...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		...
		if (user != null) {
			...
			return new SimpleAuthenticationInfo(new ShiroUser(user.getEmail(), user.getName(), user.getId(),
					user.getHead(), user.getBio()), user.getPassword(), ByteSource.Util.bytes(salt), getName());
		} else {
			return null;
		}
	}
