...
<body>
	<div id="wrapper">
		<div id="navigation" class="with-border">
			...
			<div class="link-bar">
				<a class="link-v1 active" href="${ctx }/u/${user.id }/likes/"> 喜爱(${likenum }) </a> <span>·</span> <a class="link-v1" href="${ctx }/u/${user.id }/posts/"> 添加(${pronum }) </a> <span>·</span> <a class="link-v1" href="${ctx }/u/${user.id }/notes/"> 点评(${comnum }) </a> <span>·</span> <a class="link-v1" href="${ctx }/u/${user.id }/tags/"> 标签(${tagnum }) </a> <label class="right ml15"> <a href="${ctx }/u/${user.id }/fans/"> 关注者 <b>${fannum }</b> 人
				</a>
						...
						<li>
							<div class="image">
								<a href="${ctx }/detail/${product.id }/" target=_blank>
									<div class="img-mask"></div> <img src="${product.picture }" title="${product.name }" />
								</a>
							</div>
